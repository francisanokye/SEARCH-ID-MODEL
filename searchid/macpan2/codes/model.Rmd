...
piecewise_spec =  (searchid_spec |> mp_tmb_insert(
    ...
    , default = list(beta = 0.42752579, gamma = 1/14, sigma = 0.35, mu = 0.6,  
                     ...
                     beta_values = c(0.35, 0.7390368, 0.695509096, 0.7390368, 0.65007704))
    , integers = list(beta_changepoints = c(0, 10, 21, 55, 90)))
)
```

```{r}
piecewise_spec = mp_tmb_insert(piecewise_spec
    ## insert this expression ...
  , expressions = list(cases ~ R * report_prob)
  , at = Inf  
  , phase = "during"
