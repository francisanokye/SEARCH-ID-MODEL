...
pp <- (ggplot(data = fitted_data, aes(x = dates, y = value))
       ...
       + labs(x = "Date (Dec 15, 2021 - March 18, 2022)", y = "Incidence", title = "SEIR Model Fit", color = "")
       + scale_color_manual(labels = c("beta", "case_fit", "data", "E", "I", "R", "report_prob", "S", "serop_fit"),
                        values = c("blue", "red", "black", "#ea801c", "#800074", "#36b700", "#298c8c", "magenta","#f1a226"))
       ...
       + theme(axis.text.x = element_text(size = 10, angle = 45, hjust = 0.5),
               ...
               legend.position = c(0.85,0.12),# "right",
