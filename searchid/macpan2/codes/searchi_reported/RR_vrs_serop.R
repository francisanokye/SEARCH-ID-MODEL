...
serodata <- serodata[(serodata$dates > "2021-12-14") &(serodata$dates <= "2022-03-18"),]
print(serodata)
population = 510550
...
plot_seroprevalence = function(cal_object) {
      ...
      fitted_data <- fitted_data[(fitted_data$dates > "2021-12-14")& (fitted_data$dates <= "2022-03-18"),]
      ggplot() +
