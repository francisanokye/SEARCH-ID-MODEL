...
searchi_spec = mp_tmb_insert(searchi_spec
...
beta_values <- c(5.10, 0.57, 0.63, 0.70, 0.63)
```
...
state_labels = c("S", "E", "A", "R", "C","H","I","cases")
...
searchid_calibrator = mp_tmb_calibrator(
  ...
  , data = observed_data
  , traj = "cases"  
  , par = c("log_beta_values", "phi", "xi", "theta", "omega", "alpha","E", "A", "I", "C", "H")
)
