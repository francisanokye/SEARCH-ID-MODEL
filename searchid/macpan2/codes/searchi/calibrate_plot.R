...
pp <- (ggplot(data = fitted_data, aes(x = dates, y = value))
       ...
       + scale_color_manual(labels = c("A","beta", "C", "case_fit", "data","E", "H", "I", "R", "report_prob", "S", "serop_fit"),
                        values = c("maroon","blue", "gray4","red", "black", "#ea801c", "violet","#800074", "#36b700", "#298c8c", "magenta","#f1a226"))
