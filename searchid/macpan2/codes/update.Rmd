...
plot_fit = function(cal_object) {
  ...
  ggplot(observed_data, aes(x = dates, y = value, colour = "black"), na.rm = TRUE) +
    ...
    annotate("text", x = as.Date("2021-12-18"), y = 700, label = expression(beta[2] == 0.32),size = 6,angle = 90, hjust = 1, color = "black")+
  annotate("text", x = as.Date("2021-12-28"), y = 700, label = expression(beta[3] == 0.74),size = 6,angle = 90, hjust = 1,color = "black")+
  annotate("text", x = as.Date("2022-01-30"), y = 550, label = expression(beta[4] == 0.68),size = 6,angle = 0, hjust = 1, color = "black")+
  # annotate("text", x = as.Date("2022-02-05"), y = 3, label = "Alert Level 3",size = 5,angle = 10, hjust = 1, color = "black")+
  annotate("text", x = as.Date("2022-03-03"), y = 550, label = expression(beta[3] == 0.74),size = 6,angle = 0, hjust = 1, color = "black")+
  annotate("text", x = as.Date("2022-05-01"), y = 1500, label = expression(beta[0] == 0.67),size = 6, hjust = 1, color = "black")+
    theme_clean() +
