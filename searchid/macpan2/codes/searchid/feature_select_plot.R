...
pp <- (ggplot(data = fitted_data, aes(x = dates, y = value))
       ...
       + scale_color_manual(labels = c( "case_fit", "data", "report_prob", "serop_fit"),values = c("red", "black", "green2", "#ea801c"))
...
ggsave("../../figures/case_serop_reportprob_plot.png", plot = pp, width = 10, height = 6, dpi = 600)
