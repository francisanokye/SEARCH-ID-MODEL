...
```{r}
source("~/Documents/MUN/SEARCH-ID-MODEL/searchid/macpan2/codes/searchid/searchid_tmb.R")

## -------------------------
## get model searchid from library
## -------------------------

searchid_spec = searchid_spec
...
mp_optimize(searchid_calibrator)

```

```{r}
euler_coef <- (mp_tmb_coef(searchid_calibrator, conf.int=TRUE)
       |> backtrans()
)
